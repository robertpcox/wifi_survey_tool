# Module map
Generated by `node tools/module_map.mjs`.
Paths are under `src/`; `.mjs` suffixes are omitted. L/B is lines/bytes.
T- lacks an adjacent test. E exports; I imports; unprefixed imports are local.
Layers: `@a/`, `@d/`, `@f/`, and `@s/`.
...
- mazemap-controls 78/2042 E createMapControls I @d/route-contract, mazemap-runtime
...
- shell.css 106/2568
## apps/runner/
- index.html 150/6613 I @f/survey-runner/runner.css, @s/app-shell.css, main
...
- runner-progress-v3 72/2045 E checkInCurrent, createRunnerProgress, startRunnerProgress, tickRunnerDwell
...
- active-run 87/2263 E createActiveRunner I @d/runner-progress-v3
- entry 55/1579 E RUNNER_ENTRY_FIELDS, normalizeRunnerEntry, runnerEntryIssues, runnerPositionRequest, syncRunnerCredentials
- form-view 129/4883 E createRunnerFormView, preflightMetrics I @s/format
- loader 29/1263 E loadRunnerDefinition, loadRunnerManifest I @d/survey-definition-v3
- poll-loop 47/1343 E createRunnerPollLoop I @a/positioning/source-contract
- preflight 52/1528 E createPreflightPollLoopOptions, runRunnerPreflight I @d/runner-preflight-v3, entry
...
- run-view 76/2695 E createRunnerRunView, targetName
- runner.css 125/3932
- setup 101/2723 E createRunnerSetup I entry, loader, poll-loop, preflight
- survey-runner 129/4327 E mountSurveyRunner
